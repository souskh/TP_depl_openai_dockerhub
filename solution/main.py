...
Optional: HUGGINGFACE_MODEL (chat/instruct Hub id for the router).
Optional: API_RESPONSE_MODEL (string returned as JSON field "model"; default = last segment of HUGGINGFACE_MODEL).
"""
...
# Chat/completions needs an instruct model your HF token can route (enable providers in Hub settings).
# Llama-3.2-1B-Instruct works for many accounts; override with HUGGINGFACE_MODEL if needed.
